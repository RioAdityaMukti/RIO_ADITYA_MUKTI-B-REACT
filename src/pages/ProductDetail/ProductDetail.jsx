...
export default function ProductDetail() {
  ...
  useEffect(() => {
    ...
    const filteredProducts = allProducts.filter((prod) => prod.slug === slug);

    // Pilih produk pertama dari array filteredProducts jika ada, atau undefined jika tidak ada
    setProduct(filteredProducts.length > 0 ? filteredProducts[0] : undefined);
  }, [slug]);
